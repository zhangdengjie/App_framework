...
public class AsyncHttpNetCenter extends BaseNetCenter {
    ...
    private static volatile AsyncHttpNetCenter instance;
    ...
    void sendRequest(int type,
        ...
        MyLogUtil.e(url);
        MyLogUtil.i("HTTP-Request,tools：Async-Http");
        ...
        MyLogUtil.i("HTTP-Request,params：" + requestParams.toString());
    ...
    String getAbsoluteApiUrl(String partUrl) {

...
import com.zdj.app.base.BaseNetCenter;
import com.zdj.app.base.BaseRequest;
import com.zdj.app.myApplication.AppManager;
import com.zdj.app.utils.MyLogUtil;
import com.zdj.app.utils.NetUtils;
...
public class OkHttpNetCenter extends BaseNetCenter {
    /**
     * 单例模式，volatile 更好的解决并发问题的出现 <br/>
     * created at 2015/12/27 12:44
     */
    private volatile static OkHttpNetCenter instance;
    ...
    private void sendRequest(int type, String url, Map<String, String> params, Callback callback) {
        ...
        MyLogUtil.i("HTTP-Request,tools：okHttp");
        MyLogUtil.i("HTTP-Request,url：" + url);
        MyLogUtil.i("HTTP-Request,mothed：" + (type == GET ? "GET" : "POST"));
        MyLogUtil.i("HTTP-Request,header：" + baseHeader.toString());
        MyLogUtil.i("HTTP-Request,params：" + params.toString());
